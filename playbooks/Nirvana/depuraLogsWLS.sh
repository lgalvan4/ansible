...
P10000_INICIA()
{
  ...
  export ID_SCRIPT="10"
  export ARGUMENTOS="$(hostname) ${DOMAIN_SERVERS_HOME} AWX" #Agregar comentario ejecucion desde AWX
...
P20000_PROCESA()
{
  ...
  echo "FS_USED: "$FS_USED" DEPURATION_THRESHOLD: "$DEPURATION_THRESHOLD
